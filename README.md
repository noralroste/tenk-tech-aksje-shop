...
For a technical overview of how the application is built, including flow diagrams for authentication, the shopping flow,
database models and more, see [ARCHITECTURE.md](ARCHITECTURE.md).
